        ...
        Surface(
            ...
            Column(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(R.string.delete_transaction_message, transactionTitle),
                ...
                Row(
                    ...
                    OutlinedButton(
                        ...
                        Text(stringResource(R.string.delete_transaction_keep))
                    }
...
@Composable
private fun DeleteTransactionConfirmDialogPreview() {
    BudgetControl_JetpackTheme(dynamicColor = false) {
        DeleteTransactionConfirmDialog(
            transactionTitle = "Ăn uống - Bữa tối",
            onDismiss = {},
            onConfirm = {}
        )
    }
